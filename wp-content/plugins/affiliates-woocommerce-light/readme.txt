...
1. Install and activate the [WooCommerce](http://wordpress.org/extend/plugins/woocommerce) plugin. Configure your shop and create products.
...
3. Install and activate the [Affiliates WooCommerce Integration Light](http://wordpress.org/extend/plugins/affiliates-woocommerce-light) plugin.
