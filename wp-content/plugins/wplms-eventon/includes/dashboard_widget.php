...
class wplms_dash_cal extends WP_Widget {
    ...
    function wplms_dash_cal() {
    $widget_ops = array( 'classname' => 'wplms_dash_cal', 'description' => __('Calendar for Dashboard', 'wplms-dashboard') );
    $control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'wplms_dash_cal' );
    $this->WP_Widget( 'wplms_dash_cal', __(' DASHBOARD : Calendar Widget', 'wplms-dashboard'), $widget_ops, $control_ops );
  }
    ...
    $content =  '[add_eventon_dv cal_id="1" today="no" show_et_ft_img="no" ft_event_priority="no" day_incre="1" month_incre="1" wplms_course="'.$courses.'"]';
    ...
    function form($instance) {  
        $defaults = array( 
                        'title'  => __('My Course Events','wplms-dashboard'),
                        'content' => '',
