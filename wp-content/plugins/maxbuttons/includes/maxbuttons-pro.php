...
?>
		...
		<div class="pro-offer">
			...
			<ul>
				...
				<li><strong><?php _e("Google Analytics Event Tracking","maxbuttons"); ?></strong> - <?php _e("With a couple settings Google Analytics can receive Event data from your buttons.","maxbuttons"); ?></li> 
			...
			<table class="compare" cellpadding="0" cellspacing="0">
				...
				<tr><td><?php _e("Button Search, to easily find specific buttons in large sets","maxbuttons") ?></td>
					<td align="center">&nbsp;</td>
					<td align="center"><img src="<?php echo $plugin_url  ?>images/checkmark-16.png" alt="Checkmark" /></td>
				</tr>
				<tr><td><?php _e("Google Analytics Event Tracking for Event Tracking on your buttons","maxbuttons") ?></td>
					<td align="center">&nbsp;</td>
					<td align="center"><img src="<?php echo $plugin_url  ?>images/checkmark-16.png" alt="Checkmark" /></td>
				</tr>				
				<tr> 
				...
				<tr>
					<td><?php _e('Regular updates and Terrific Support', 'maxbuttons') ?></td>
					<td align="center"><img src="<?php echo $plugin_url  ?>images/checkmark-16.png" alt="Checkmark" /></td>
					<td align="center"><img src="<?php echo $plugin_url  ?>images/checkmark-16.png" alt="Checkmark" /></td>
				</tr>								
			</table>
