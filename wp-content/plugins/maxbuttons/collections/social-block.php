...
class socialCollectionBlock extends collectionBlock
{
	...
	*/	
		...
		global $supported_networks; 
	 	...
	 	switch ($field)
	 	{
	 		...
	 		case "count_threshold": 
				$networks = array("facebook","google-plus","linkedin","pinterest","reddit","stumbleupon", "twitter","vkontakte"); 
	 		break;
	...
	?><div class="mb_tab social_block option-container" data-options="social">
	    ...
	    <span class='manual-box'><a class='manual-toggle' data-target="social"> <?php _e("Getting Started","maxbuttons-pro"); ?> </a></span> 
