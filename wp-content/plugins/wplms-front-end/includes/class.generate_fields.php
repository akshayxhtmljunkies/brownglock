			...
			'course_settings'=>array(
					...
					'fields'=>array(
						array(
							...
							'id' => 'vibe_duration',
							'from'=> 'meta',
							'extra' => calculate_duration_time($course_duration_parameter),
							'default'=>9999,
						...
						array(
							...
							'hide_nodes'=> array('vibe_course_section_drip','vibe_course_drip_duration'),
						...
						array(
							...
							'from'=> 'meta',
							'extra' => calculate_duration_time($drip_duration_parameter),
							'default'=>1,
	...
	function generate_fields($field,$id = null){
		...
		switch($field['type']){
				...
				<ul id="<?php echo $field['id']; ?>" class="wplms-taxonomy">
                    <li>
                        <select id="<?php echo $field['id']; ?>-select" class="chosen post_field" <?php echo 'data-id="'.$field['id'].'" data-taxonomy="'.$field['taxonomy'].'" data-type="'.$field['type'].'"'; ?>>
                            ...
                            <?php $new_tax = apply_filters('wplms_front_end_new_tax_cap',true);if($new_tax) {?>
			...
			case 'group':
				...
				echo '</h3>';
				?>
				<div id="change_group" <?php echo (($flag)?'style="display:none;"':''); ?>>
					<div class="col-md-6">
			...
			case 'forum':
				...
				echo '</h3>'; ?>
				<div id="change_forum" <?php echo (($flag)?'style="display:none;"':''); ?>>
					<div class="col-md-6">
			...
			case 'selectproduct':
				...
				$product_duration_parameter = apply_filters('vibe_product_duration_parameter',86400); 
									$product_fields= apply_filters('wplms_front_end_new_product',array(
										...
										'hide_nodes'=> array('vibe_duration'),
										...
										'style'=>'',
										'id' => 'vibe_duration',
										'extra' => calculate_duration_time($product_duration_parameter),
										'from'=> 'meta',
				...
				<div id="change_product" class="field_wrapper" <?php if(empty($field['value'])){echo 'style="display:block;"';}else{echo 'style="display:none;"';} ?>>
