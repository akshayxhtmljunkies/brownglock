		...
		<div class="wrap wplms-wrap about-wrap">
			...
			<div class="changelog">
				<div class="wplms-feature feature-rest feature-section col two-col">
					<div class="col-1">
						...
						<p><?php _e( 'We updated a lot of components in WPLMS. Architectural changes to enhance performance. And we fixed some pending bugs. Refer to change log for complete list of issues/bugs fixed in the update.', 'vibe' ); ?></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/1-9-9/" class="button"><?php _e( 'Check issue log ', 'vibe' ); ?></a>
					</div>
					<div class="col-2">
						<h4><?php _e( 'Events & Front End Revamp Update', 'vibe' ); ?></h4>
			...
			<div class="changelog about-integrations">
				...
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4><?php _e( 'Modern Child Theme', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/modern.png'; ?>" /></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/modern-theme-installation/" class="button">Tutorial</a>
					</div>
					<div>
						<h4><?php _e( 'Frond End Revamp', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/frontend.png'; ?>" /></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/wplms-front-end-update/" class="button">Tutorial</a>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'EventOn', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/eventon.png'; ?>" /></p>
						<a href=" http://vibethemes.com/documentation/wplms/knowledge-base/wplms-eventon/" class="button">Tutorial</a>
					</div>
				</div>
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4><?php _e( 'Permalinks', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/permalinks.png'; ?>" /></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/wplms-permalinks/" class="button">Tutorial</a>
					</div>
					<div>
						<h4><?php _e( 'Course Location', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/location.png'; ?>" /></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/course-location-taxonomy/" class="button">Tutorial</a>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'Course Filters', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/filters.png'; ?>" /></p>
					</div>
				</div>
			</div>
			<div class="changelog">
				<div class="feature-section col three-col">
					<div>
						<h4><?php _e( 'Variable Pricing Addon', 'vibe' ); ?></h4>
					...
					<div class="last-feature">
						...
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/1-9-9/"><?php _e( 'Check Translation files status','vibe'); ?></a>
					</div>
				</div>
			</div>
			<div class="return-to-dashboard">
